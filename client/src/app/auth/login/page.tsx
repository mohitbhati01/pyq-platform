    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-2">Sign in to your account</p>
        </div>
        ...
        <div className="card p-6 shadow-sm">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full border border-zinc-200 dark:border-zinc-700 rounded-lg py-2.5 text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors mb-4"
          >
          ...
          <form onSubmit={handleSubmit((d) => loginMutation.mutate(d))} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-brand-600 dark:text-brand-400 hover:underline">Forgot?</Link>
              </div>
            ...
            <button type="submit" disabled={loginMutation.isPending} className="btn-primary w-full flex items-center justify-center gap-2">
        ...
        <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-4">
          ...
          <Link href="/auth/register" className="text-brand-600 dark:text-brand-400 font-medium hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  );
